                ...
                <div className="grid gap-6 md:grid-cols-2">
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>配置向量化参数</CardDescription>
                        </CardHeader>
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>配置大语言模型相关参数</CardDescription>
                        </CardHeader>
                        <CardContent className="space-y-4">
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>连接参数设置</CardDescription>
                        </CardHeader>
                        <CardContent className="space-y-4">
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>控制文档块大小与重叠</CardDescription>
                        </CardHeader>
                        <CardContent className="space-y-4">
